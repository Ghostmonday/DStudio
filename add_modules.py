...
for file_name in module_files:
    ...
    # Add file reference
    file_ref = f"""
		1A0000{file_uuid[:6]} /* {file_name} */ = {{isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = {file_name}; sourceTree = "<group>"; }};"""
    ...
    modules_replacement = r'\1\n\t\t\t1A0000' + file_uuid[:6] + f' /* {file_name} */,'
    
    # Add to build file
    build_file = f"""
		1A0000{build_uuid[:6]} /* {file_name} in Sources */ = {{isa = PBXBuildFile; fileRef = 1A0000{file_uuid[:6]} /* {file_name} */; }};"""
...
print("Added all 3 module files to project")
